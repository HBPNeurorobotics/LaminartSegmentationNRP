...
def buildNetworkAndConnections(sim, ImageNumPixelRows, ImageNumPixelColumns, numOrientations, oriFilterSize, V1PoolSize, V2PoolSize,
    ...
    LGNBrightInput = sim.Population(ImageNumPixelRows*ImageNumPixelColumns, normalCellType, label="LGNBrightInput") # temporary solution for test purpose (to change to actual input)
    LGNDarkInput   = sim.Population(ImageNumPixelRows*ImageNumPixelColumns, normalCellType, label="LGNDarkInput")   # temporary solution for test purpose (to change to actual input)
    ...
    LGNBright = sim.Population(ImageNumPixelRows*ImageNumPixelColumns, normalCellType)
    ...
    V2layer23       = sim.Population(numSegmentationLayers*numOrientations*numPixelRows*numPixelColumns, normalCellType)
